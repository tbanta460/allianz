        ...
        <div id="mobile-view">
            ...
            <div class="is-body container-body color-primary position-relative d-flex flex-column pt-3">
                ...
                <div class="row gap-2 mt-3">
                    <a class="col" href="{{ asset('img/a (1).png') }}" data-fancybox="gallery" data-caption="Caption #2">
                        <img class="img-thumbnail" src="{{ asset('img/a (1).png') }}" alt="asdasd" />
                    </a>
                    <a class="col" href="{{ asset('img/a (4).png') }}" data-fancybox="gallery" data-caption="Caption #2">
                        <img class="img-thumbnail" src="{{ asset('img/a (4).png') }}" alt="asdasd" />
                    </a>
                </div>
                <div class="row gap-2 mt-3">
                    <a class="col" href="{{ asset('img/a (5).png') }}" data-fancybox="gallery" data-caption="Caption #2">
                        <img class="img-thumbnail" src="{{ asset('img/a (5).png') }}" alt="asdasd" />
                    </a>
                    <a class="col" href="{{ asset('img/a (11).png') }}" data-fancybox="gallery" data-caption="Caption #2">
