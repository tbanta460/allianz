...
<body class="">
    ...
    <div class="containers text-white">
        ...
        <div id="mobile-view">
            ...
            <div>
                <div class="btn-group btn-group-cstm color-primary" role="group"
                    aria-label="Basic radio toggle button group">
                    <input type="radio" class="btn-check" name="btnradio" id="qr_code" autocomplete="off" checked>
                    <label class="btn btn-outline-primary color-primary" for="qr_code">My QR Code</label>

                    <input type="radio" class="btn-check" name="btnradio" id="pov_camera" autocomplete="off">
                    <label class="btn btn-outline-primary color-primary" for="pov_camera">POV Camera</label>
                </div>
            </div>
            <div class="is-body container-body color-primary position-relative" id="qr-pov">
                <div class="d-flex flex-column gap-2 pt-5">
                    ...
                    <div class="card-body mx-auto ">
                        ...
                        <button type="button" class="text-white fw-bold btn btn-info">Other QR</button>
                    </div>
                </div>
